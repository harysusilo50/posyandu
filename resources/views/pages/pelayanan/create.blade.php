...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-muted"><i class="fas fa-ambulance mr-1"></i> Tambah Data Pelayanan Baru
            </h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('pelayanan.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="input-group">
                            <input id="tinggi_badan" type="text" pattern="([0-9]+.{0,1}[0-9]*,{0,1})*[0-9]"
                                ...
                                value="{{ old('tinggi_badan') }}" required autocomplete="tinggi_badan" autofocus>
                            <div class="input-group-append">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="input-group">
                            <input id="berat_badan" type="text" pattern="([0-9]+.{0,1}[0-9]*,{0,1})*[0-9]"
                                ...
                                value="{{ old('berat_badan') }}" required autocomplete="berat_badan" autofocus>
                            <div class="input-group-append">
                                <span class=" input-group-text">
                                    Kg
                                </span>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="input-group">
                            <input id="lingkar_kepala" type="text" pattern="([0-9]+.{0,1}[0-9]*,{0,1})*[0-9]"
                                ...
                                value="{{ old('lingkar_kepala') }}" required autocomplete="lingkar_kepala" autofocus>
                            <div class="input-group-append">
                                <span class=" input-group-text">
                                    Cm
                                </span>
                        ...
                        <div class="input-group">
                            ...
                            <select id="jenis_imunisasi" class="form-control @error('jenis_imunisasi') is-invalid @enderror"
                                ...
                                @foreach ($jenis_imunisasi as $item)
                                    <option
                                        value="{{ $item->nama }}"{{ old('jenis_imunisasi') == $item->nama ? ' selected' : '' }}>
                                        {{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <select id="jenis_vitamin" class="form-control @error('jenis_vitamin') is-invalid @enderror"
                                ...
                                @foreach ($jenis_vitamin as $item)
                                    <option
                                        value="{{ $item->nama }}"{{ old('jenis_vitamin') == $item->nama ? ' selected' : '' }}>
                                        {{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input id="tanggal_pelayanan" type="datetime-local"
                        ...
                        value="{{ old('tanggal_pelayanan') }}" required autocomplete="tanggal_pelayanan" autofocus>
