@extends('layout.app')
@section('title', 'Settings Daily Scoop, Container Cleaning & Sanitation')
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-muted"><i class="fas fa-cogs mr-1"></i> Settings Machine Daily Scoop,
                Container Cleaning & Sanitation</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
